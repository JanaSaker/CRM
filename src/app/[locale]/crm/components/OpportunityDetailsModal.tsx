            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              <div>
                ...
                <p>
                  ...
                  <Tag severity="success" value={data.status} />
                </p>
                <p>
              ...
              <div>
                ...
                <p>
                  ...
                  <Tag severity="success" value={data.dealStatus} />
                </p>
                <p>
              ...
              <div className="relative p-4 bg-white rounded-md shadow-md">
                ...
                >
                  ...
                  <Column
                    ...
                    sortable
                    filter
                    filterPlaceholder="Filter Duration"
                  ></Column>
                  <Column
                    field="outcome"
                    header="Outcome"
                    sortable
                    filter
                    filterPlaceholder="Filter Outcome"
                  ></Column>
                  <Column
                    field="note"
                    header="Note"
